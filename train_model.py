...
def main():
    ...
    # Save real training stats so the Streamlit app can display genuine
    # numbers instead of a hardcoded/fake accuracy figure.
    metrics = {
    ...
    print("\nDone! Created fake_news_model.pkl, tfidf_vectorizer.pkl, and model_metrics.json")
